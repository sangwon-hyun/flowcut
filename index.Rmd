...
install.packages("~/repos/flowcut/flowcut", type='source',repos=NULL)
...
my_load <- function(){litr::render("~/repos/flowcut/index.Rmd", output_format = litr::litr_gitbook(minimal_eval = TRUE))
